...
version = cosmos.__version__[:1]
# The full version, including alpha/beta/rc tags.
release = cosmos.__version__[1:]
...
html_theme_path = ['readthedocs-sphinx']

# The name for this set of Sphinx documents.  If None, it defaults to
# "<project> v<release> documentation".
html_title = "Cosmos v{0}{1} documentation".format(version,release)
